...
Te, Z0, ne, t_end, omg_pe = initial_condition(100., 1., 1.0e18, 10e-9)
...
def nu_B(temp,coul_alog, Z0, ne, omg_ts, omg_pe):
    return 3.1e-7 * Z0 * ne**2 * coul_alog * temp**(-1.5) * omg_ts**-2. * (1.-omg_pe**2/omg_ts**2)**(-0.5)   # cm^-1


print(nu_B(Te, LMD2(Te, ne, Z0, omg_ts), Z0, ne, omg_ts, omg_pe))
